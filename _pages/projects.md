...
A directed reading project organized by the Mathematics Department at the University of Toronto. Explored topics such as: Perron-Frobenius theorem, (n,d,c)-expanders, Expander-mixing lemma, Pseudorandom graphs, Laplacian spectrum with applications to graph drawings under the supervision of PhD student [Narmada Varadarajan](https://narmada.info/). Click [here](Spectral_Graph_Theory_DRP%20(2).pdf) to view the slides used in the talk.
